...
const socials = [
  {
    Icon: FaLinkedinIn,
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/awanishsingh07/",
  },
  {
    Icon: FaGithub,
    label: "GitHub",
    href: "https://github.com/awanishsingh07",
  },
  { Icon: FaXTwitter, label: "X", href: "https://x.com/Code_SpectrA" },
  {
    Icon: FaInstagram,
    label: "Instagram",
    href: "https://www.instagram.com/awanish.singh07/",
  },
];
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              I build responsive web applications and backend systems using
