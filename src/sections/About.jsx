...
import p from "../assets/awanish_picture.jpg";
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            <h2 className="pb-2 leading-tight text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#1CD8D2] via-[#00bf8f] to-[#302b63]">
              Awanish Kumar Singh
            </h2>
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              ...
              and user-friendly applications using Java, Spring Boot, React,
              Tailwind CSS, and MySQL. I enjoy creating clean interfaces, secure
              backend systems, and real-world solutions that deliver smooth user
              experiences.{" "}
            </p>
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              ...
              building fast and efficient applications. I am always learning new
